...
type MissionKey = 'items' | 'me' | 'history' | 'categories' | 'statistics';
...
const COLOR = {
  ...
  purple: {
    ...
    glow: 'shadow-[0_0_0_1px_rgba(168,85,247,0.3),0_0_18px_rgba(168,85,247,0.25)]',
    btn: 'bg-purple-500 hover:bg-purple-400 hover:scale-105 active:scale-95',
    icon: 'text-purple-50',
...
export default function Page() {
  ...
  const cards: MissionCard[] = [
    ...
    { key: 'categories', title: '카테고리', subtitle: '카테고리를 관리하세요', action: '미션 시작', color: 'pink' },
    {
      key: 'statistics',
      title: '통계',
      subtitle: '카테고리별 평균 사용 기간을 확인하세요',
      action: '미션 시작',
      color: 'purple',
    },
  ];
    ...
    <div className="min-h-screen bg-[#070a12] text-white">
      <main className="mx-auto w-full max-w-6xl px-6 pb-14 pt-8">
        <div className="mb-8 text-center">
          <h2 className="inline-block text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-green-500 to-blue-500 mb-2">
            레인저 미션 센터
          </h2>
            ...
            <div className="mt-5 space-y-3">
              ...
              {!isLoading &&
                ...
                today.map((m) => (
                  <div
                    key={m.id}
                    className="flex items-center justify-between rounded-xl bg-white/5 p-4 ring-1 ring-white/15"
                  >
